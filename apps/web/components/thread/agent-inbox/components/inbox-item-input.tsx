...
import { Textarea } from "@hexio/ui/components/textarea";
...
import { Separator } from "@hexio/ui/components/separator";
  ...
  return (
    <div className="flex flex-col gap-4 p-6 items-start w-full rounded-xl border-[1px] border-gray-300">
      ...
      <div className="flex items-center justify-end w-full gap-2">
        <Button variant="ghost" disabled={streaming} onClick={handleSubmit}>
          Send Response
        </Button>
      </div>
    </div>
